...
public:
	...
	constexpr uint32_t get_type() { return PACKAGE_TYPE; }
	...
	constexpr void deserialize(Engine::span<uint8_t> _data)
	{
...
/// basic writing
void operator<<(NetworkPackage::Writer& writer, const uint8_t& value);
void operator<<(NetworkPackage::Writer& writer, const uint16_t& value);
void operator<<(NetworkPackage::Writer& writer, const uint32_t& value);
void operator<<(NetworkPackage::Writer& writer, const int8_t& value);
void operator<<(NetworkPackage::Writer& writer, const int16_t& value);
void operator<<(NetworkPackage::Writer& writer, const int32_t& value);
void operator<<(NetworkPackage::Writer& writer, const glm::vec3& value);
void operator<<(NetworkPackage::Writer& writer, const glm::quat& value);
void operator<<(NetworkPackage::Writer& writer, const std::string& value); /// Assumes sizeof(char) == 1
void operator<<(NetworkPackage::Writer& writer, const float& value);
void operator<<(NetworkPackage::Writer& writer, const std::vector<uint8_t>& value);
void operator<<(NetworkPackage::Writer& writer, const std::vector<uint16_t>& value);
void operator<<(NetworkPackage::Writer& writer, const std::vector<uint32_t>& value);

/// basic reading
void operator>>(NetworkPackage::Writer& writer, uint8_t& value);
void operator>>(NetworkPackage::Writer& writer, uint16_t& value);
void operator>>(NetworkPackage::Writer& writer, uint32_t& value);
void operator>>(NetworkPackage::Writer& writer, int8_t& value);
void operator>>(NetworkPackage::Writer& writer, int16_t& value);
void operator>>(NetworkPackage::Writer& writer, int32_t& value);
void operator>>(NetworkPackage::Writer& writer, glm::vec3& value);
void operator>>(NetworkPackage::Writer& writer, glm::quat& value);
void operator>>(NetworkPackage::Writer& writer, std::string& value); /// Assumes sizeof(char) == 1
void operator>>(NetworkPackage::Writer& writer, float& value);
void operator>>(NetworkPackage::Writer& writer, std::vector<uint8_t>& value);
void operator>>(NetworkPackage::Writer& writer, std::vector<uint16_t>& value);
void operator>>(NetworkPackage::Writer& writer, std::vector<uint32_t>& value);
